                ...
                %>
                        ...
                        <form  class="form-horizontal form-label-left" action="addAccount" method="post">
                                ...
                                <div class="form-group">
                                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Login (recipient) <span class="required">*</span>
                                      </label>
                                  ...
                                  <div class="form-group">
                                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Name (recipient) <span class="required">*</span>
                                      </label>
                                      <div class="col-md-6 col-sm-6 col-sm-12">
