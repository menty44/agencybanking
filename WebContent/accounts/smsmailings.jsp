                ...
                %>
                        ...
                        <form  class="form-horizontal form-label-left" action="addManageAccount" method="post">
                                      ...
                                      <div class="form-group">
                                           <label class="col-md-3 col-sm-3 col-xs-12 control-label">llll
                                               <br>
                                           </label>
                                           ...
                                           <div class="col-md-9 col-sm-9 col-xs-12">
                                               <div class="radio">
                                                   <label>
                                                       <input type="radio"  name="optionforex" id="optionforex1" value="true">All
                                                   </label>
                                                   <label>
                                                       <input type="radio" name="optionforex" id="optionforex2" value="false">To group
                                                   </label>
                                                   <label>
                                                       <input type="radio" name="optionforex" id="optionforex2" value="false">To member
                                                   </label>
                                               </div>
