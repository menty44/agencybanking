                ...
                %>
                        ...
                        <form  class="form-horizontal form-label-left" action="addManageAccount" method="post">
                          <div class="form-group">
                                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">New registered members <span class="required">*</span>
                                      </label>
                                  <div class="col-md-6 col-sm-6 col-xs-12">
                                   <select name="networkuuid" id="input" class="form-control col-md-3 col-xs-12">
                                     <option value="">No items selected</option>
                                     <option value="press">Disabled brokers</option>
                                     <option value="net">Disabled members</option>
                                     <option value="press">Full brokers</option>
                                     <option value="net">Full members</option>
                                     <option value="press">Inactive members</option>

                                   </select>
                                </div>  </div>

                                <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Payments <span class="required">*</span>
                                            </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                         <select name="networkuuid" id="input" class="form-control col-md-3 col-xs-12">
                                           <option value="">No items selected</option>
                                           <option value="press">Community to debit</option>
                                           <option value="net">Community to member</option>
                                           <option value="press">Community to organization</option>
                                           <option value="net">Community to voucher</option>
                                           <option value="press">Debit to community</option>
                                           <option value="net">Debit to member</option>
                                           <option value="press">Debit to organization</option>
                                           <option value="net">Member to community </option>
                                           <option value="press">Member to organization</option>
                                           <option value="net">Money deposit</option>
                                           <option value="press">Organization to community</option>
                                           <option value="net">Organization to debit</option>
                                           <option value="press">Organization to member</option>
                                           <option value="net">Organization to voucher</option>
                                           <option value="press">Sacco Deposit</option>
                                           <option value="net">Sacco-Members Transfer</option>
                                           <option value="press">Voucher buying</option>
                                           <option value="net">Voucher cashing</option>
                                           <option value="press">Voucher creation</option>
                                           <option value="net">Voucher destruction</option>
                                           <option value="press">Voucher to community</option>
                                           <option value="net">Voucher to organization</option>

                                         </select>
                                      </div>  </div>

                                      <div class="form-group">
                                                  <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">New payment awaiting authorization <span class="required">*</span>
                                                  </label>
                                              <div class="col-md-6 col-sm-6 col-xs-12">
                                               <select name="networkuuid" id="input" class="form-control col-md-3 col-xs-12">
                                                 <option value="">No items selected</option>
                                            ...
                                            <div class="form-group">
                                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Messages <span class="required">*</span>
                                                        </label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                     <select name="networkuuid" id="input" class="form-control col-md-3 col-xs-12">
                                                       <option value="">No items selected</option>
                                                       <option value="press">Administration</option>
                                                       <option value="net">Loan request</option>
                                                       <option value="net">Support</option>

                                                     </select>
                                                  </div>  </div>

                                                  <div class="form-group">
                                                              <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">System alerts <span class="required">*</span>
                                                              </label>
                                                          <div class="col-md-6 col-sm-6 col-xs-12">
                                                           <select name="networkuuid" id="input" class="form-control col-md-3 col-xs-12">
                                                             <option value="">No items selected</option>
                                                             <option value="press">Application restarted</option>
                                                             <option value="net">Application shutdown</option>
                                                             <option value="press">Account fee running</option>
                                                             <option value="net">Account fee finished</option>
                                                             <option value="press">Account fee finished with errors</option>
                                                             <option value="net">Max incorrect login attempts for invalid user</option>
                                                             <option value="press">Max incorrect login attempts for admin</option>
                                                             <option value="net">Admin login temporarily blocked by permission denied</option>
                                                             <option value="press">Admin transaction password blocked by tries</option>
                                                             <option value="net">New version of application page</option>
                                                             <option value="press">New version of static file</option>
                                                             <option value="net">New version of help file</option>
                                                             <option value="press">Search index rebuilding start</option>
                                                             <option value="net">Search index rebuilding end</option>
                                                             <option value="press">A negative virtual rated balance has been encountered on a system account</option>
                                                             <option value="net">Unexpected null I-rate encountered</option>
                                                             <option value="press">rate initialization job finished</option>
                                                             <option value="net">rate initialization job started</option>
                                                             <option value="press">Rate initialization job on currency null failed due to an encountered exception</option>
                                                        ...
                                                        <div class="form-group">
                                                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Member alerts <span class="required">*</span>
                                                                    </label>
                                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                                 <select name="networkuuid" id="input" class="form-control col-md-3 col-xs-12">
                                                                   <option value="">No items selected</option>
                                                                   <option value="press">Member blocked by exceeding login attempts</option>
                                                                   <option value="net">Member login temporarily blocked by permission denied </option>
                                                                   <option value="press">Pin blocked by invalid tries</option>
                                                                   <option value="net">Transaction blocked by exceeding attempts</option>
                                                                   <option value="press">Expired system to member invoice</option>
                                                                   <option value="net">Member denied too many invoices</option>
                                                                   <option value="press">Member gave too many \'very bad\' references</option>
                                                                   <option value="net">Member received too many \'very bad\' references</option>
                                                                   <option value="press">Expired loan', value:'EXPIRED_LOAN</option>
                                                                   <option value="net">Scheduled payment failed</option>
                                                                   <option value="press">Attempt to use a POS device marked as blocked</option>
                                                                   <option value="net">Card security code blocked by invalid tries</option>
                                                                   <option value="net">A negative virtual rated balance has been encountered</option>
                                                                   <option value="net">Unexpected null I-rate encountered</option>
                                                                   <option value="net">Activation of account failed</option>
                                                                   <option value="net">Initial credit transaction failed</option>
                                                              ...
                                                              <div class="form-group">
                                                                   ...
                                                                   <div class="col-md-9 col-sm-9 col-xs-12">
                                                                       <div class="radio">
                                                                           <label>
                                                                               <input type="radio"  name="optionforex" id="optionforex1" value="true">Application errors
                                                                           </label>
                                                                           <label>
                                                                               <input type="radio" name="optionforex" id="optionforex2" value="false">System invoices
                                                                           </label>
                                                                       </div>
