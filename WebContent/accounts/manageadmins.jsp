            ...
            <div class="right_col" role="main">
                ...
                %>
                        ...
                        <form  class="form-horizontal form-label-left" action="addAccount" method="post">
                          ...
                          <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Admin group <span class="required">*</span>
                                        </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                     <select name="networkuuid" id="input" class="form-control col-md-3 col-xs-12">
                                       ...
                                       <option value="net">Removed administrators</option>
                                  ...
                                  <div class="form-group">
                                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Create administrator <span class="required">*</span>
                                                </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                             <select name="networkuuid" id="input" class="form-control col-md-3 col-xs-12">
                                               <option value="">Choose..</option>
                                               <option value="2">Account administrators</option>
