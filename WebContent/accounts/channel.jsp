                ...
                %>
                        ...
                        <form  class="form-horizontal form-label-left" action="addAccount" method="post">
                          ...
                          <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Internal name <span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-sm-12">
                                     ...
                                     <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">User identification<span class="required">*</span>
                                    </label>
                          ...
                          <option value="DETAILED" selected="selected">Detailed tracing (including parameters)</option>
                               ...
                               <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Default user identification <span class="required">*</span>
                                    </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                 <select name="networkuuid" id="input" class="form-control col-md-3 col-xs-12"> <option value="ERRORS">off</option>
                                     <option value="ERRORS">Errors only</option>
                          ...
                          <option value="DETAILED" selected="selected">Detailed tracing (including parameters)</option>
                               ...
                               <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Credentials <span class="required">*</span>
                                    </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                 <select name="networkuuid" id="input" class="form-control col-md-3 col-xs-12"> <option value="ERRORS">off</option>
                                     <option value="ERRORS">Errors only</option>
                          ...
                          <option value="DETAILED" selected="selected">Detailed tracing (including parameters)</option>
                                     ...
                                     <div class="form-group">
                                           <label class="col-md-3 col-sm-3 col-xs-12 control-label">Supports payment request
                                               <br>
                                           </label>
