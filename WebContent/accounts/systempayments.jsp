                          ...
                          <div class="form-group">
                           ...
                           <div class="col-md-6 col-sm-6 col-xs-12">
                            <select name="networkuuid" id="input" class="form-control col-md-3 col-xs-12">
                              ...
                              <option value="net">Community to debit</option>
                              <option value="mouth">Community to voucher</option>
                              <option value="mouth">Debit to community</option>
                              <option value="mouth">Debit to organization</option>
                              <option value="mouth">Organization to community</option>
                              <option value="mouth">Organization to debit</option>
                              <option value="mouth">Organization to voucher</option>
                              <option value="mouth">Voucher creation</option>
                              <option value="mouth">Voucher destruction</option>

                              <option value="mouth">Voucher to community</option>
                              <option value="mouth">Voucher to organization</option>
