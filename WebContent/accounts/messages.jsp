                ...
                %>
                        ...
                        <form  class="form-horizontal form-label-left" action="addAccount" method="post">
                          <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Message box <span class="required">*</span>
                                        </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                     <select name="networkuuid" id="input" class="form-control col-md-3 col-xs-12">
                                       <option value="">Inbox..</option>
                                       <option value="press">Sent items</option>
                                       <option value="net"> Trash</option>
                                  ...
                                  <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                             <select name="networkuuid" id="input" class="form-control col-md-3 col-xs-12">
                                               ...
                                               <option value="press">Support</option>
                                               <option value="net">Administration</option>
