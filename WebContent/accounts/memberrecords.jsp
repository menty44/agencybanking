                          ...
                          <div class="form-group">
                                  ...
                                  <div class="col-md-6 col-sm-6 col-xs-12">
                                   <select name="networkuuid" id="input" class="form-control col-md-3 col-xs-12">
                                     ...
                                     <option value="press">Member</option>
                                     <option value="net">System</option>
                                      ...
                                      <div class="form-group">
                                          <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Label (plural)<span class="required">*</span>
                                          </label>
                                          <div class="col-md-6 col-sm-6 col-xs-12">
                                      ...
                                      <div class="form-group">
                                          <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Groups <span class="required">*</span>
                                          </label>
                                      <div class="col-md-6 col-sm-6 col-xs-12">
                                       <select name="networkuuid" id="input" class="form-control col-md-3 col-xs-12">
                                         <option value="">Choose..</option>
                                         <option value="press">Account administrators</option>
                                         <option value="net">Disabled administrators</option>
                                         <option value="net">Disabled brokers</option>
                                         <option value="net">Disabled members</option>
                                         <option value="net">Full brokers</option>
                                         <option value="net">Full members</option>
                                         <option value="net">Inactive members</option>
                                         <option value="net">System administrators</option>
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Search results layout	 <span class="required">*</span>
                                        </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                     <select name="networkuuid" id="input" class="form-control col-md-3 col-xs-12">
                                       <option value="press">Tiled</option>
                                       <option value="net">List</option>
                                  ...
                                  <div class="form-group">
                                           ...
                                           <div class="col-md-9 col-sm-9 col-xs-12">
                                               <div class="radio">
                                                   <label>
                                                       <input type="radio"  name="optionforex" id="optionforex1" value="true">Show menu item
                                                   </label>
                                                   <label>
                                                       <input type="radio" name="optionforex" id="optionforex2" value="false">Editable
                                                   </label>
                                               </div>
