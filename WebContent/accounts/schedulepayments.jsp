                          ...
                          <div class="form-group">
                                     ...
                                     <div class="col-md-6 col-sm-6 col-xs-12">
                                      <select name="networkuuid" id="input" class="form-control col-md-3 col-xs-12">
                                        ...
                                        <option value="press">Community account</option>
                                        <option value="1">Demo Bank Debit Account</option>
                                       <option value="4">Organization account</option>
                                       <option value="3">Voucher account</option></select>
                                     ...
                                     <div class="col-md-6 col-sm-6 col-xs-12">
                                      <select name="networkuuid" id="input" class="form-control col-md-3 col-xs-12">
                                        <option value="">Choose..</option>
                                        <option value="press">Open</option>
                                        <option value="net">Closed (Entirely Paid)</option>
                                        <option value="mouth">Closed (Partialy Paid)</option>
